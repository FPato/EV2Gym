...
class EV2Gym(gym.Env):
    ...
    def __init__(self,
        ...
        self.pv_ae = AE.load('autoencoder/models/N_solar_ae_to16dim.pt')
        self.load_ae = AE.load('autoencoder/models/N_loads_ae_to16dim.pt') # was 4dim
        self.prices_ae = AE.load('autoencoder/models/N_prices_ae_to16dim.pt')
